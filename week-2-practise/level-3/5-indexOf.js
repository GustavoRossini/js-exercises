...
var replaceItemIndex = arr.indexOf(valueToReplace);
 
newArrValue = [newValue];

return arr.slice(0, replaceItemIndex).concat(newArrValue).concat(arr.slice(replaceItemIndex + 1))// complete this statement
}
